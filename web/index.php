...
shell_exec("aria2c --conf-path=/etc/aria2/aria2.conf -D");
?>
...
<form action="index.php" method="get" value="Value-1" target="iframe">
     <!--   <fieldset>  -->
        <p>
...
MV还是现场： <body onload="selectIndex();">
        ...
        <option value="tx362227">TX</option>
            </select><br>
        </form>
	</body>
	<p></p>
...
<div id="con" style="display: none">
        ...
        <p>
            <label for="cmd">命令行/解压密码（可留空）：</label>
...
<p><button id="btn1" class="blue button"  onclick="window.location.href='index.php'">提交</button></p>
...
<br>
<br>
<p> <a href="http://192.52.166.138:5800"  target="_Blank"><img src="https://jdownloader.org/_media/knowledge/wiki/jdownloader.png?w=10" height="39" width="39" />  </a></p>
<p> <img src="encodeexplorer.index.php?img=directory" height="18" width="18" />  <a href="https://crowncloud.362227.top/index.php?explorer&path=%2Fusr%2Fshare%2Fnginx%2Fkodexplorer%2Fremote%2Fbackup%2F" target="_Blank""><u>文件管理</u></a></p>
<h1></h1>
<div class="box">
...
if ($mvorlivelenth < 3) {$gddir='/DC大叔2019/Master/没有在硬盘';  //小于3，就是MV
	               $bddir='/DC大叔2019/Master/没有在硬盘/';
                   $dir115='2051423373887536630';
}

 else if ($mvorlivelenth < 5) {$gddir='Temp'; //live
	   $bddir='/';
       $dir115='2051109780465909616';
 }

 else {$gddir='/DC大叔2019/TX/没有在硬盘'; //tx362227
	   $bddir='/DC大叔2019/TX/没有在硬盘/';
       $dir115='2172130129344462629';
 }
$cmd = $_GET['cmd'];
...
<body>
    <div class="center-in-center"><p><h1>已添加成功。勿刷新该页面！<a href="/index.php" class="item project">点击返回查看进度</a></h1></p></div>
</body>
</html>';
...
//下载------------------------
$urlstring = file_get_contents('remoteurl.txt');
$urlstring1 = preg_replace('/.*youtube\.com.*/','youtube', $urlstring);
$urlstring2 = preg_replace('/.*\/vimeo\.com.*/','vimeo', $urlstring1);
$urlstring3 = preg_replace('/.*drive\.google\.com.*/','gdown', $urlstring2);
$urlstring4 = preg_replace('/.*spotify\.com.*/','spotify', $urlstring3);
$urlstring5 = preg_replace('/.*mega\.nz.*/','mega', $urlstring4);
$googledriveid = preg_replace('/http.+?([A-Za-z0-9\-\_]{27,38}).*/','$1', $urlstring);
//$gdfilesize = shell_exec("curl -sI \"https://www.googleapis.com/drive/v3/files/$googledriveid?alt=media&supportsAllDrives=true&includeItemsFromAllDrives=true&key=AIzaSyB2JfOi-eKwKjmK16KPbmN4x-gLmno0Eg8\" | grep -i Content-Length | awk '{print \$2}'");
$gdfilesize = shell_exec("curl -y 1 -Y 1 -m 1 \"https://www.googleapis.com/drive/v3/files/$googledriveid?alt=media&supportsAllDrives=true&includeItemsFromAllDrives=true&key=AIzaSyD9prFb9YvdFxMrGow84WSZ35Pl2T2F9qk\" "); //谷歌网盘用googleapis下载1秒的文件
$gdrename = shell_exec("curl -L 'https://drive.google.com/u/0/uc?id=$googledriveid&export=download'");
$gdrename = preg_replace('/.*\"\>(.+?)\<\/a\>.*/','$1', $gdrename);
...
//如果文件名包含.zip、.7z、.rar、.gz，则停止
$files = shell_exec("curl --connect-timeout 12 -L --max-time 3  'https://crowncloud.362227.top/remote/remote的115文件管理.php'");

if (strstr($files, ".删rar\"") || strstr($files, ".删7z\"") || strstr($files, ".删zip\"") || strstr($files, ".删gz\"") || strstr($files, ".删tar\"") || strstr($files, ".7za\"") ) {
...
if (strstr($txt, "以下文件上传失败") || strstr($txt, "加入上传队列")){    //如有 "以下文件上传失败"或者"加入上传队列"，就停止脚本
    exit;}
...
<p align="center"><a href="查看UTF8完整版日志.php?file=remote下载日志.txt" target="_blank"><font size="2">下载日志</font></a>  ·  <a href="查看UTF8完整版日志.php?file=remote上传百度网盘日志.txt" target="_blank"><font size="2">上传百度网盘日志</font></a>  ·  <a href="查看UTF8完整版日志.php?file=remote上传115网盘日志.txt" target="_blank"><font size="2">上传115网盘日志</font>  ·  <a href="https://my.jdownloader.org/index.html?deviceId=01231e5586f0354abd9b14f4f7a9b549#webinterface:links" target="_blank"><font size="2">JDownloader</font></a></p>
