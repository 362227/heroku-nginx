...
function upload_file {
    file=$1
    $2 fake115uploader -e --oss-proxy http://127.0.0.1:1083 -c 2596786305585036490 -u "$file" || fake115uploader -e --oss-proxy http://127.0.0.1:1083 -c 2596786305585036490  -parts-num 37 -m "$file"
