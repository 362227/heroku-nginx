...
#for i in "${IP[@]}";do echo "$i"  >> ref下载log;  aria2c  -x16  $proxy    --referer=$i -i "合并${num}000000-${num}999999有ref链接的aria2c文本.txt" --file-allocation=none --max-concurrent-downloads=500  --max-download-result=10000000 --disk-cache=0 --check-certificate=false --dir=/mnt/d/常用/vimeo/传统方法刷-下载后再处理数据-刷json/temp/ref >> ref下载log; find /mnt/d/常用/vimeo/传统方法刷-下载后再处理数据-刷json/temp/ref -type f -size -555c -exec rm {} +; done  
for i in "${IP[@]}";do echo "$i"  >> ref下载log;  python 下载0000000000000ref.py  -i "合并${num}000000-${num}999999有ref链接的aria2c文本.txt"  -r "$i" -d "/mnt/d/常用/vimeo/传统方法刷-下载后再处理数据-刷json/temp/ref" >> ref下载log; find /mnt/d/常用/vimeo/传统方法刷-下载后再处理数据-刷json/temp/ref -type f -size -555c -exec rm {} +;  for file in /mnt/d/常用/vimeo/传统方法刷-下载后再处理数据-刷json/temp/ref/*; do mv "$file" "${file}_"; done;done  
...
echo 合并大文件
find "/mnt/d/常用/vimeo/传统方法刷-下载后再处理数据-刷json/temp/01"  -type f -name "*" | xargs sed 'a\' > /mnt/d/常用/vimeo/传统方法刷-下载后再处理数据-刷json/合并${num}000000-${num}999999
find "/mnt/d/常用/vimeo/传统方法刷-下载后再处理数据-刷json/temp/02"  -type f -name "*" | xargs sed 'a\' >> /mnt/d/常用/vimeo/传统方法刷-下载后再处理数据-刷json/合并${num}000000-${num}999999
find "/mnt/d/常用/vimeo/传统方法刷-下载后再处理数据-刷json/temp/ref"  -type f -name "*" | xargs sed 'a\' >> /mnt/d/常用/vimeo/传统方法刷-下载后再处理数据-刷json/合并${num}000000-${num}999999


echo 删除反斜杆
sed -i 's/\\//g' 合并${num}000000-${num}999999
...
echo 下载失败的链接
python3 /mnt/d/常用/vimeo/传统方法刷-下载后再处理数据-刷json/从log文件提取下载失败的链接.py > /mnt/d/常用/vimeo/传统方法刷-下载后再处理数据-刷json/遗漏文件链接合并.txt
