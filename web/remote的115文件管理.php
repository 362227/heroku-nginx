...
$page = file_get_contents($actual_link.'/remote/encodeexplorer.index.php?m&sort_by=mod&sort_as=desc&dir=backup/');
$page = str_replace("src=\"?img","src=\"/remote/encodeexplorer.index.php?img",$page);
...
$page = file_get_contents($actual_link.'/remote/encodeexplorer.index.php?m&sort_by=mod&sort_as=desc&dir=remote115mv/');
$page = str_replace("src=\"?img","src=\"/remote/encodeexplorer.index.php?img",$page);
...
$page = file_get_contents($actual_link.'/remote/encodeexplorer.index.php?m&sort_by=mod&sort_as=desc&dir=remote115live/');
$page = str_replace("src=\"?img","src=\"/remote/encodeexplorer.index.php?img",$page);
...
$page = file_get_contents($actual_link.'/remote/encodeexplorer.index.php?m&sort_by=mod&sort_as=desc&dir=remote115tx362227/');
$page = str_replace("src=\"?img","src=\"/remote/encodeexplorer.index.php?img",$page);
$page = str_replace("<a href=\"?s&amp;dir=remote115tx362227/\">","<a href=\"/remote/encodeexplorer.index.php?sort_by=mod&sort_as=desc&dir=remote115tx362227/\" target=\"_blank\">",$page);
$page = str_replace("已离线的文件，每个文件大约1-2小时后删","TX，差上传115网盘",$page);
echo '<hr /><br>'.$page;


$page = file_get_contents($actual_link.'/remote/encodeexplorer.index.php?m&sort_by=mod&sort_as=desc&dir=spotify/');
$page = str_replace("src=\"?img","src=\"/remote/encodeexplorer.index.php?img",$page);
