...
for ($i = 0; $i < $loop_count; $i++) {
  ...
  $curl_cmd = "删curl https://player.vimeo.com/video/$id --referer $ref1 & 删curl https://player.vimeo.com/video/$id --referer $ref2 & 删curl https://player.vimeo.com/video/$id --referer $ref3 
  ";
 #echo $curl_cmd;
